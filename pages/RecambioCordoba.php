    ...
    <div id="wrapper">
	  ...
	  <?php include("formenvios.php");?>
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Recambio Informático Mapfre Cordoba </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="col-lg-6">
						<div class="alert alert-success alert-dismissable">
							...
							<?php
							$query = 'select estatus, count(*) from recambiocordoba group by estatus';
							...
							echo "Total de Equipos para Cambiar en Cordoba=$cant</p>";
							?>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            Listado de recambios equipos Cordoba
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
							...
							<table class="table table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
										<?php
										$query = "select id,sucursal,direccion,empleado,numa,cargo, par, ip,observacion,modelo,ram,cpu,hd,estatus,parnew,serial,sistema,fecha_cambio FROM recambiocordoba  ORDER BY estatus ASC";
										$result = pg_query($query) or die('La consulta fallo: ' . pg_last_error());
										...
										while ($row = pg_fetch_row($result)) {
											...
											if($row[13]=="NO SE ENCUENTRA")
											{
												$cadena=$cadena."<option selected value='NO SE ENCUENTRA' >NO SE ENCUENTRA</option>";
											}else{
												$cadena=$cadena."<option value='NO SE ENCUENTRA'>NO SE ENCUENTRA</option>";
											}
											if($row[13]=="PROCESO")
											{
												$cadena=$cadena."<option selected value='PROCESO' >EN PROCESO</option>";
