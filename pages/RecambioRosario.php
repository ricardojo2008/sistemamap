    ...
    <div id="wrapper">
	  ...
	  <?php include("formenvios.php");?>
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Recambio Informático Mapfre Rosario </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="col-lg-6">
						<div class="alert alert-success alert-dismissable">
							...
							<?php
							$query = 'select estatus, count(*) from recambiorosario group by estatus';
							...
							echo "Total de Equipos para Cambiar en Rosario=$cant</p>";
							?>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            Listado de recambios equipos Rosario
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
							...
							<table class="table table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
										<?php
										$query = "select id,sucursal,direccion,empleado,numa,cargo, par, ip,observacion,modelo,ram,cpu,hd,estatus,parnew,serial,sistema,fecha_cambio FROM recambiorosario  ORDER BY estatus ASC";
										$result = pg_query($query) or die('La consulta fallo: ' . pg_last_error());
