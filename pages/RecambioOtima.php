...
<?php  if(trim($_SERVER['REMOTE_ADDR'])=="10.220.1.86" ||trim($_SERVER['REMOTE_ADDR'])=="10.220.1.178" || trim($_SERVER['REMOTE_ADDR'])=="10.220.0.68" || trim($_SERVER['REMOTE_ADDR'])==trim(":::1") || trim($_SERVER['REMOTE_ADDR'])=="10.216.149.120" || trim($_SERVER['REMOTE_ADDR'])=="10.220.0.36" || trim($_SERVER['REMOTE_ADDR'])=="10.220.1.114"){?>
<body>
    <div id="wrapper">
	  ...
	  <?php include("formenvios.php");?>
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Recambio Informático Mapfre Optima </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="col-lg-6">
						<div class="alert alert-success alert-dismissable">
							...
							<?php
							$query = 'select estatus, count(*) from recambioptima group by estatus';
							...
							echo "Total de Equipos para Cambiar en Optima=$cant</p>";
							echo "<br><p>Equipos Enviados: <br>Parque Leloir	1</p>";
							echo "<br><p>Mar del Plata	9</p>.";
							echo "<br><p>Rosario	11</p>";
							echo "<br><p>Mendoza	13</p>";
							echo "<br><p>Cordoba	15</p><br><br><p>TOTAL DE EQUIPOS ENVIADOS= 49</p>";
							?>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            Listado de recambios equipos Optima
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
							...
							<table class="table table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
										<?php
										$query = "select id,sucursal,direccion,empleado,numa,cargo, par, ip,observacion,modelo,ram,cpu,hd,estatus,parnew,serial,sistema,fecha_cambio FROM recambioptima  ORDER BY estatus ASC";
										$result = pg_query($query) or die('La consulta fallo: ' . pg_last_error());
										...
										while ($row = pg_fetch_row($result)) {
											...
											if($row[13]=="NO SE CAMBIA")
											{
												$cadena=$cadena."<option selected value='NO SE CAMBIA' >NO SE CAMBIA</option>";
											}else{
												$cadena=$cadena."<option value='NO SE CAMBIA'>NO SE CAMBIA</option>";
											}
											if($row[13]=="TECNICO OPTIMA")
											{
												$cadena=$cadena."<option selected value='TECNICO OPTIMA' >TECNICO OPTIMA</option>";
											}else{
												$cadena=$cadena."<option value='TECNICO OPTIMA'>TECNICO OPTIMA</option>";
											}
											if($row[13]=="PROCESO")
											{
											...
											if($row[13]=="NO EXISTE")
											{
												$cadena=$cadena."<option selected value='NO EXISTE' >NO EXISTE</option>";
											}else{
												$cadena=$cadena."<option value='NO EXISTE'>NO EXISTE</option>";
											}
											if($row[13]=="CAMBIADO")
											{
...
<?php }else{echo "No esta autorizado, para entrar a este sitio comunicarse al 3029 ó enviar en mail al tec07@mapfre.com.ar. Gracias.";}?>
