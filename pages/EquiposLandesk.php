...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Equipos Landesk</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
equipos_landesk
(
    nom_par character varying(500) COLLATE pg_catalog."default",
    tipo character varying(500) COLLATE pg_catalog."default",
    sistema character varying(500) COLLATE pg_catalog."default",
    ip character varying(500) COLLATE pg_catalog."default",
    gateway character varying(500) COLLATE pg_catalog."default",
    scan character varying(500) COLLATE pg_catalog."default",
    usuario character varying(500) COLLATE pg_catalog."default"
)
*/
