    ...
    <div id="wrapper">
	  ...
	  <?php include("formenvios.php");?>
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Recambio Informático Mapfre Mar del Plata </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="col-lg-6">
						<div class="alert alert-success alert-dismissable">
							...
							<?php
							$query = 'select estatus, count(*) from recambiomardelplata group by estatus';
							...
							echo "Total de Equipos para Cambiar en Mar del Plata=$cant</p>";
							?>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            Listado de recambios equipos Mar del Plata
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
							...
							<table class="table table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
										<?php
										$query = "select id,sucursal,direccion,empleado,numa,cargo, par, ip,observacion,modelo,ram,cpu,hd,estatus,parnew,serial,sistema,fecha_cambio FROM recambiomardelplata  ORDER BY estatus ASC";
										$result = pg_query($query) or die('La consulta fallo: ' . pg_last_error());
