    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Sistem Mapfre</a>
            </div>
            <!-- /.navbar-header -->
...
$query = 'SELECT componente,modelo,marca,ubicacion FROM envios order by componente asc';
