    ...
    <div id="wrapper">
	  ...
	  <?php include("formenvios.php");?>
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Recambio Informático LaValle </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
			<div class="row">
				<div class="col-lg-12">					
					...
					<div class="col-lg-6">
						<div class="alert alert-success alert-dismissable">					
							...
							<?php
							$query = 'select estatus, count(*) from recambio group by estatus';
							...
							echo "<br><p>Total de Equipos para Cambiar en Lavalle=$cant</p>";
							echo "<br><p>Nota: Realizar el racambio de los equipos con PRIORIDAD: (1)ACOSTA JOSE ALBERTO / JOSEALT / PAR001001-2134. (2) CATULLO ALEJANDRO EZEQUIEL / CATULLO / PAR001001-813 </p>";
							?>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            Listado de recambios equipos de Lavalle
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
							...
							<table class="table table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
										<?php
										$query = 'select id,sucursal,direccion,empleado,numa,cargo, par, ip,observacion,modelo,ram,cpu,hd,estatus,parnew,serial,sistema,fecha_cambio FROM recambio ORDER BY id DESC';
										$result = pg_query($query) or die('La consulta fallo: ' . pg_last_error());
										...
										while ($row = pg_fetch_row($result)) {
											$muestraboton="<button  onClick='verificar($row[0])' class='btn btn-default'><i class='fa fa-save'></i></button>";
										...
										echo"<a href='envios.php?id='$row[0]''><tr> <a href='formenvios.php?id='$row[0]',hacer='editar''>
											...
											<td>
												<select $apagar name='estatus$row[0]' id='estatus$row[0]' class='form-control'>
												$cadena
                                                </select>
											</td>
											<td>
												<input  class='form-control' $apagar size='12' id='new$row[0]' name='new$row[0]' value='$row[14]' placeholder='Definir'>
											</td>
											<td>																						
												<input  class='form-control' $apagar size='12' id='serial$row[0]' name='serial$row[0]' value='$row[15]' placeholder='Serial'>
											</td>
											<td>					 
											$muestraboton
											</td>
