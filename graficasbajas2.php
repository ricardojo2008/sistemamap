		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				...
				<table class="table table-hover" id="dataTables-example2">
						...
						<tbody>
							<?php
							$query = "select id,sucursal,direccion,empleado,numa,cargo, par, ip,observacion,modelo,ram,cpu,hd,estatus,parnew,serial,sucursal,fecha_cambio FROM recambioptima where estatus='CAMBIADO' and serial ilike '4c%'  ORDER BY fecha_cambio DESC";
